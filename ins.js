      ...
      var render = function render(res) {
        ...
        for (var j = 0, len2 = res.list.length; j < len2; j++) {
          ...
          for (var i = 0, len = data.link.length; i < len; i++) {
            var minSrc =
              "https://raw.githubusercontent.com/MarkChenyyds/blogPhotos/main/min_photos/" +
              data.link[i];
            var src =
              "https://raw.githubusercontent.com/MarkChenyyds/blogPhotos/main/photos/" +
              data.link[i];
            ...
            liTmpl +=
              ...
              '" data-src="' +
              minSrc +
              '" src="/blog/assets/img/empty.png" itemprop="thumbnail" onload="lzld(this)">\
                </a>\
